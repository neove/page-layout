...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.showPlaceHolderWhileDrag = function showPlaceHolderWhileDrag(pixelX, pixelY, i) {
   ...
   * @param  {Number} w Left position (relative to parent) in pixels.
   * @param  {Number} h Left position (relative to parent) in pixels.
   * @return {Object} x and y in grid units.
   */
  ReactGridLayout.prototype.calcXY = function calcXY(top, left, w, h) {
  ...
  ReactGridLayout.prototype.calcColWidth = function calcColWidth() {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.addGridOnDropPosition = function (pixelX, pixelY, i) {
    var _refs$gridItem$calcXY2 = _this3.refs.gridItem.calcXY(pixelY, pixelX),
    ...
    // Set state
    var newLayout = (0, _utils.compact)(layout, _this3.props.verticalCompact);
